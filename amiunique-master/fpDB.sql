...
--
-- Table structure for table `extensionDataScheme`
--

CREATE TABLE IF NOT EXISTS `extensionDataScheme` (
...
--
-- Indexes for table `extensionDataScheme`
--
ALTER TABLE `extensionDataScheme`
...
--
-- AUTO_INCREMENT for table `extensionDataScheme`
--
ALTER TABLE `extensionDataScheme`
