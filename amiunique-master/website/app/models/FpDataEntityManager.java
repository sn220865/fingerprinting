...
public class FpDataEntityManager {
    ...
    public CounterMap getTimezoneStats(){
        String timeQuery = "SELECT timezoneJS, count(timezoneJS) FROM extensionDataScheme GROUP BY timezoneJS";
    ...
    public CounterMap getTimezoneStatsSinceDate(Timestamp tsl, Timestamp tsu){
        String timeQuery = "SELECT timezoneJS, count(timezoneJS) FROM extensionDataScheme WHERE time BETWEEN :lower AND :upper GROUP BY timezoneJS";
